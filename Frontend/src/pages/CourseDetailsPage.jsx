...
import { getEmbedUrl } from '../utils/helpers.js';
    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-purple-50 py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <div className="bg-white rounded-2xl shadow-xl p-10 border border-gray-100">
          {course.videoUrl && (
            <div className="mb-12">
              <h2 className="text-3xl font-bold mb-6 text-gray-800">📺 Course Preview</h2>
              <div className="aspect-w-16 aspect-h-9 rounded-2xl overflow-hidden shadow-xl border-4 border-white bg-black">
                <iframe
